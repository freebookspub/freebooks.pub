...
import { makeDir, moveDir, cleanDir, copyFile } from './lib/fs';
import run from './run';

// GitHub Pages
const remote = {
  name: 'github',
  url: 'https://github.com/freebookspub/freebookspub.github.io.git',
  branch: 'master',
  website: 'https://freebooks.pub/',
  static: true,
};
...
async function deploy() {
  ...
  if (process.argv.includes('--static')) {
    ...
    await copyFile('public/CNAME', 'build/CNAME');
